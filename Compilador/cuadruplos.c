...
// FUNCTION: buscaCuad(Cuadruplos *cuadruplo, contador)
// RETURN: Cuadruplos
//
// Funcion que busca un cuadruplo dado su numero de cuadruplo y regresa ese mismo cuadruplo encontrado para ser modificado
//
