...
exp1: {funcionOperaciones("20");} MENOS {stack_push(&PilaOperadores, (char *) "20", 1);} exp;
exp1: ;
...
varcte: CTENUM {meterConstanteAPilaOperandos("numero");} | CTEDEC {meterConstanteAPilaOperandos("decimal");} | CTEX {meterConstanteAPilaOperandos("texto");} | CCAR {meterConstanteAPilaOperandos("caracter");} | TRUE | FALSE;
varcte: variable ;
